...
--
-- Хост: localhost
-- Время создания: Мар 27 2018 г., 14:35
...
CREATE TABLE `cars` (
  ...
  `motor` varchar(255) COLLATE utf8_unicode_ci DEFAULT NULL,
...
(1, 'SKODA', 6, 'skoda_logo.png', 'описание производителя Шкода'),
...
(5, 'CHEVROLET', 6, 'chevrolet_logo.png', 'Chevrolet (МФА ʃɛvrəˈleɪ[1]), (в США также неофициально Chevy [Ше́ви]) — марка автомобилей, производимых и реализуемых одноимённым экономически самостоятельным подразделением корпорации General Motors. \r\nChevrolet является самой популярной среди марок концерна GM: в 2007 году было реализовано около 2,6 млн автомобилей[источник не указан 110 дней].'),
(6, 'Automobils', 0, 'category_cars.png', 'Категория автомобили'),
(7, 'Volkswagen', 7, 'ford_fiesta.jpg', 'Volkswagen ([fɔlksˈvaːɡn]) — немецкая автомобильная марка, одна из многих, принадлежащих концерну Volkswagen AG. Под этой маркой в 2007 году было реализовано 5 млн 20 тыс. автомобилей. Штаб-квартира — в Вольфсбурге');
...
--
ALTER TABLE `cars`
  ADD CONSTRAINT `fk-cars-category-categories-id` FOREIGN KEY (`category`) REFERENCES `categories` (`id`) ON DELETE SET NULL ON UPDATE CASCADE;
